...
public class MyGame extends Game {
	...
	protected void initCanvas() {
        ...
        for (int textLine = 0; textLine < textStrings.length; textLine++)
        {
            textID                          = "textOverBackground" + Integer.toString(textLine);
            textOverBackground[textLine]    = new Text(textID, textStrings[textLine], textPositionX, textPositionY);
            textOverBackground[textLine].setColor(textColor);
            textOverBackground[textLine].setFontName(textFont);
            textOverBackground[textLine].setFontSize(textSize);
            canvas.addShape(textOverBackground[textLine]);
            textPositionY                   += textDeltaInY;
        }
	}
